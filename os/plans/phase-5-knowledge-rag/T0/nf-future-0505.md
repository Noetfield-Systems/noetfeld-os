...
domain: agent
no_asf: true
nf_plan_id: NF-PLAN-0505
generator: scripts/generate-future-plans.py
---

# Migrate agent for knowledge rag (T0, #0505)
...
Migrate **agent** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
