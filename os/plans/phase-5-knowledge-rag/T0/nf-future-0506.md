...
domain: policy
no_asf: true
nf_plan_id: NF-PLAN-0506
generator: scripts/generate-future-plans.py
---

# Ship policy for knowledge rag (T0, #0506)
...
Ship **policy** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
