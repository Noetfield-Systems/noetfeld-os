...
domain: sample
no_asf: true
nf_plan_id: NF-PLAN-0512
generator: scripts/generate-future-plans.py
---

# Ship sample for knowledge rag (T0, #0512)
...
Ship **sample** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
