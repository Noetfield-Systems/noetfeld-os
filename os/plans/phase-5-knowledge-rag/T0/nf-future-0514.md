...
domain: connectors
no_asf: true
nf_plan_id: NF-PLAN-0514
generator: scripts/generate-future-plans.py
---

# Migrate connectors for knowledge rag (T0, #0514)
...
Migrate **connectors** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
