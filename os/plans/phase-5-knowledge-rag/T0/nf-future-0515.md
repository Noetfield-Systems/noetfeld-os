...
domain: rbac
no_asf: true
nf_plan_id: NF-PLAN-0515
generator: scripts/generate-future-plans.py
---

# Ship rbac for knowledge rag (T0, #0515)
...
Ship **rbac** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
