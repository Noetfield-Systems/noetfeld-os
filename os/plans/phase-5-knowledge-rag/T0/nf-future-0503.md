...
domain: export
no_asf: true
nf_plan_id: NF-PLAN-0503
generator: scripts/generate-future-plans.py
---

# Ship export for knowledge rag (T0, #0503)
...
Ship **export** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
