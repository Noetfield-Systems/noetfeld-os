...
domain: ingest
no_asf: true
nf_plan_id: NF-PLAN-0508
generator: scripts/generate-future-plans.py
---

# Migrate ingest for knowledge rag (T0, #0508)
...
Migrate **ingest** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
