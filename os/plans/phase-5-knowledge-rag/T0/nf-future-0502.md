...
domain: workspace
no_asf: true
nf_plan_id: NF-PLAN-0502
generator: scripts/generate-future-plans.py
---

# Migrate workspace for knowledge rag (T0, #0502)
...
Migrate **workspace** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
