...
domain: workflow
no_asf: true
nf_plan_id: NF-PLAN-0517
generator: scripts/generate-future-plans.py
---

# Migrate workflow for knowledge rag (T0, #0517)
...
Migrate **workflow** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
