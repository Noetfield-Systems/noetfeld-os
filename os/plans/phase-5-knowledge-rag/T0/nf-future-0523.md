...
domain: tenant
no_asf: true
nf_plan_id: NF-PLAN-0523
generator: scripts/generate-future-plans.py
---

# Migrate tenant for knowledge rag (T0, #0523)
...
Migrate **tenant** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
