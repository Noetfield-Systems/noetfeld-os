...
domain: ops
no_asf: true
nf_plan_id: NF-PLAN-0520
generator: scripts/generate-future-plans.py
---

# Migrate ops for knowledge rag (T0, #0520)
...
Migrate **ops** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
