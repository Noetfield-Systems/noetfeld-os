...
domain: pilot
no_asf: true
nf_plan_id: NF-PLAN-0511
generator: scripts/generate-future-plans.py
---

# Migrate pilot for knowledge rag (T0, #0511)
...
Migrate **pilot** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
