...
domain: docs
no_asf: true
nf_plan_id: NF-PLAN-0521
generator: scripts/generate-future-plans.py
---

# Ship docs for knowledge rag (T0, #0521)
...
Ship **docs** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
