...
domain: workflow
no_asf: true
nf_plan_id: NF-PLAN-0542
generator: scripts/generate-future-plans.py
---

# Test workflow for knowledge rag (T1, #0542)
...
Test **workflow** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
