...
domain: rbac
no_asf: true
nf_plan_id: NF-PLAN-0540
generator: scripts/generate-future-plans.py
---

# Document rbac for knowledge rag (T1, #0540)
...
Document **rbac** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
