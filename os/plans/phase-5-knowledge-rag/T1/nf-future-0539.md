...
domain: connectors
no_asf: true
nf_plan_id: NF-PLAN-0539
generator: scripts/generate-future-plans.py
---

# Test connectors for knowledge rag (T1, #0539)
...
Test **connectors** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
