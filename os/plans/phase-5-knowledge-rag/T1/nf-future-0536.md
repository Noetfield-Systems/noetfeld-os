...
domain: pilot
no_asf: true
nf_plan_id: NF-PLAN-0536
generator: scripts/generate-future-plans.py
---

# Test pilot for knowledge rag (T1, #0536)
...
Test **pilot** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
