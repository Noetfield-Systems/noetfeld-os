...
domain: agent
no_asf: true
nf_plan_id: NF-PLAN-0530
generator: scripts/generate-future-plans.py
---

# Test agent for knowledge rag (T1, #0530)
...
Test **agent** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
