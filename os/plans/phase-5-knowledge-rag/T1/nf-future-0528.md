...
domain: export
no_asf: true
nf_plan_id: NF-PLAN-0528
generator: scripts/generate-future-plans.py
---

# Document export for knowledge rag (T1, #0528)
...
Document **export** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
