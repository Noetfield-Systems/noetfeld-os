...
domain: workspace
no_asf: true
nf_plan_id: NF-PLAN-0527
generator: scripts/generate-future-plans.py
---

# Test workspace for knowledge rag (T1, #0527)
...
Test **workspace** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
