...
domain: ingest
no_asf: true
nf_plan_id: NF-PLAN-0533
generator: scripts/generate-future-plans.py
---

# Test ingest for knowledge rag (T1, #0533)
...
Test **ingest** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
