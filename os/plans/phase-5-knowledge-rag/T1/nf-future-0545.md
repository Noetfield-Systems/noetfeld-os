...
domain: ops
no_asf: true
nf_plan_id: NF-PLAN-0545
generator: scripts/generate-future-plans.py
---

# Test ops for knowledge rag (T1, #0545)
...
Test **ops** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
