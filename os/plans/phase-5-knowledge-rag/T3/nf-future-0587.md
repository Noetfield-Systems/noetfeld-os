...
domain: sample
no_asf: true
nf_plan_id: NF-PLAN-0587
generator: scripts/generate-future-plans.py
---

# Optimize sample for knowledge rag (T3, #0587)
...
Optimize **sample** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
