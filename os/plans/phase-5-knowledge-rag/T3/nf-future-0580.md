...
domain: agent
no_asf: true
nf_plan_id: NF-PLAN-0580
generator: scripts/generate-future-plans.py
---

# Validate agent for knowledge rag (T3, #0580)
...
Validate **agent** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
