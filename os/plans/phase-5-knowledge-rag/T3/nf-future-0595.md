...
domain: ops
no_asf: true
nf_plan_id: NF-PLAN-0595
generator: scripts/generate-future-plans.py
---

# Validate ops for knowledge rag (T3, #0595)
...
Validate **ops** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
