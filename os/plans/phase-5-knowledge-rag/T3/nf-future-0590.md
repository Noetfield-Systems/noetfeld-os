...
domain: rbac
no_asf: true
nf_plan_id: NF-PLAN-0590
generator: scripts/generate-future-plans.py
---

# Optimize rbac for knowledge rag (T3, #0590)
...
Optimize **rbac** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
