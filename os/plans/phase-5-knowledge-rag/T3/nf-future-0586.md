...
domain: pilot
no_asf: true
nf_plan_id: NF-PLAN-0586
generator: scripts/generate-future-plans.py
---

# Validate pilot for knowledge rag (T3, #0586)
...
Validate **pilot** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
