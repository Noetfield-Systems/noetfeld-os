...
domain: docs
no_asf: true
nf_plan_id: NF-PLAN-0571
generator: scripts/generate-future-plans.py
---

# Expose docs for knowledge rag (T2, #0571)
...
Expose **docs** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
