...
domain: sample
no_asf: true
nf_plan_id: NF-PLAN-0562
generator: scripts/generate-future-plans.py
---

# Expose sample for knowledge rag (T2, #0562)
...
Expose **sample** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
