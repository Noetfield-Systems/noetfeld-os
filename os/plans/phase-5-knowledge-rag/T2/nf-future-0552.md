...
domain: workspace
no_asf: true
nf_plan_id: NF-PLAN-0552
generator: scripts/generate-future-plans.py
---

# Extend workspace for knowledge rag (T2, #0552)
...
Extend **workspace** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
