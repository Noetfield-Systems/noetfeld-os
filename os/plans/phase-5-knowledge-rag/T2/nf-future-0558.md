...
domain: ingest
no_asf: true
nf_plan_id: NF-PLAN-0558
generator: scripts/generate-future-plans.py
---

# Extend ingest for knowledge rag (T2, #0558)
...
Extend **ingest** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
