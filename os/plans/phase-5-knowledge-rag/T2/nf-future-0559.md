...
domain: api
no_asf: true
nf_plan_id: NF-PLAN-0559
generator: scripts/generate-future-plans.py
---

# Expose api for knowledge rag (T2, #0559)
...
Expose **api** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
