...
domain: agent
no_asf: true
nf_plan_id: NF-PLAN-0555
generator: scripts/generate-future-plans.py
---

# Extend agent for knowledge rag (T2, #0555)
...
Extend **agent** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
