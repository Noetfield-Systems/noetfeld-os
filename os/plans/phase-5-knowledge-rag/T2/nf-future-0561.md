...
domain: pilot
no_asf: true
nf_plan_id: NF-PLAN-0561
generator: scripts/generate-future-plans.py
---

# Extend pilot for knowledge rag (T2, #0561)
...
Extend **pilot** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
