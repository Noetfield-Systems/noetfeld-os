...
domain: tenant
no_asf: true
nf_plan_id: NF-PLAN-0573
generator: scripts/generate-future-plans.py
---

# Extend tenant for knowledge rag (T2, #0573)
...
Extend **tenant** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
