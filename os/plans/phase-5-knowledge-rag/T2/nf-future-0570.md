...
domain: ops
no_asf: true
nf_plan_id: NF-PLAN-0570
generator: scripts/generate-future-plans.py
---

# Extend ops for knowledge rag (T2, #0570)
...
Extend **ops** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
