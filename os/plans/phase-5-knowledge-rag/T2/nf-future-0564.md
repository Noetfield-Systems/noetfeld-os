...
domain: connectors
no_asf: true
nf_plan_id: NF-PLAN-0564
generator: scripts/generate-future-plans.py
---

# Extend connectors for knowledge rag (T2, #0564)
...
Extend **connectors** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
