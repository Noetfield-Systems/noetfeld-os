...
domain: export
no_asf: true
nf_plan_id: NF-PLAN-0553
generator: scripts/generate-future-plans.py
---

# Expose export for knowledge rag (T2, #0553)
...
Expose **export** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
