...
domain: copilot
no_asf: true
nf_plan_id: NF-PLAN-0554
generator: scripts/generate-future-plans.py
---

# Instrument copilot for knowledge rag (T2, #0554)
...
Instrument **copilot** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
