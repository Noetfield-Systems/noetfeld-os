...
domain: rag
no_asf: true
nf_plan_id: NF-PLAN-0568
generator: scripts/generate-future-plans.py
---

# Expose rag for knowledge rag (T2, #0568)
...
Expose **rag** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
