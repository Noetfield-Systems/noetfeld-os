...
domain: procurement
no_asf: true
nf_plan_id: NF-PLAN-0574
generator: scripts/generate-future-plans.py
---

# Expose procurement for knowledge rag (T2, #0574)
...
Expose **procurement** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
