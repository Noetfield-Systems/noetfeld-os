...
domain: workflow
no_asf: true
nf_plan_id: NF-PLAN-0567
generator: scripts/generate-future-plans.py
---

# Extend workflow for knowledge rag (T2, #0567)
...
Extend **workflow** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
