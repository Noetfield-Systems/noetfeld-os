...
domain: security
no_asf: true
nf_plan_id: NF-PLAN-0560
generator: scripts/generate-future-plans.py
---

# Instrument security for knowledge rag (T2, #0560)
...
Instrument **security** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
