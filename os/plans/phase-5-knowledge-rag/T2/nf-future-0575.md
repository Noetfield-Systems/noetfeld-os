...
domain: kms
no_asf: true
nf_plan_id: NF-PLAN-0575
generator: scripts/generate-future-plans.py
---

# Instrument kms for knowledge rag (T2, #0575)
...
Instrument **kms** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
