...
domain: risk
no_asf: true
nf_plan_id: NF-PLAN-0569
generator: scripts/generate-future-plans.py
---

# Instrument risk for knowledge rag (T2, #0569)
...
Instrument **risk** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
