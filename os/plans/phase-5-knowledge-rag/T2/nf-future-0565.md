...
domain: rbac
no_asf: true
nf_plan_id: NF-PLAN-0565
generator: scripts/generate-future-plans.py
---

# Expose rbac for knowledge rag (T2, #0565)
...
Expose **rbac** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
