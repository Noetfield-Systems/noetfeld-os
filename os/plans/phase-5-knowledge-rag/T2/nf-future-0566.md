...
domain: audit
no_asf: true
nf_plan_id: NF-PLAN-0566
generator: scripts/generate-future-plans.py
---

# Instrument audit for knowledge rag (T2, #0566)
...
Instrument **audit** capabilities so Noetfield moves toward long-term Trust Ledger + Copilot readiness without waiting for external dispatch.
