# nf-mkt-0863 — Collibra · Pricing & packaging
...
Add or update one public price card on `Noetfield NW1 Copilot governance + board pack` inspired by Collibra packaging motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0863`
