# nf-mkt-0870 — Collibra · Pricing & packaging
...
Close nf-mkt-0870: PRIORITY row + verify PASS + link https://www.collibra.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0870`
