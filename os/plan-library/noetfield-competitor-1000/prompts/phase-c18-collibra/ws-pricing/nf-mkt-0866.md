# nf-mkt-0866 — Collibra · Pricing & packaging
...
Document why buyers pay per Collibra: AI outputs need data lineage — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0866`
