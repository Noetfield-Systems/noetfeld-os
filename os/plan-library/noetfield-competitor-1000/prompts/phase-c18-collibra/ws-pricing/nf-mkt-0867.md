# nf-mkt-0867 — Collibra · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Collibra upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0867`
