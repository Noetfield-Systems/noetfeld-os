# nf-mkt-0865 — Collibra · Pricing & packaging
...
Compare Collibra PLG motion (Incumbent data gov extends to AI) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`

## Implementation extraction

`Collibra · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0865`
