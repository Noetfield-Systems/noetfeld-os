# nf-mkt-0869 — Collibra · Pricing & packaging
...
Write competitor row evidence: Collibra pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0869`
