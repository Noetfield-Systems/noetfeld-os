# nf-mkt-0861 — Collibra · Pricing & packaging
...
Capture Collibra public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0861`
