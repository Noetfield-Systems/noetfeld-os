# nf-mkt-0897 — Collibra · Integrations & API
...
Rate-limit + retry policy copied from Collibra operating model (Catalog data and AI; lineage; policy)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0897`
