# nf-mkt-0891 — Collibra · Integrations & API
...
List Collibra integrations/APIs from https://www.collibra.com or docs — pick one we can wire this quarter

## Implementation extraction

`Collibra · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0891`
