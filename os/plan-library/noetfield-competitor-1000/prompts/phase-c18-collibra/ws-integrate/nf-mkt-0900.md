# nf-mkt-0900 — Collibra · Integrations & API
...
Close nf-mkt-0900: integration receipt + verify PASS + https://www.collibra.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0900`
