# nf-mkt-0881 — Collibra · Onboarding & PLG
...
Document Collibra onboarding path (Incumbent data gov extends to AI): who runs (Enterprise SaaS (pattern reference)) → first value moment

## Implementation extraction

`Collibra · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0881`
