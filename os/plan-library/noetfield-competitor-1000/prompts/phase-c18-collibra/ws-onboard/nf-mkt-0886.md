# nf-mkt-0886 — Collibra · Onboarding & PLG
...
Write founder-facing SOW snippet if Collibra uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0886`
