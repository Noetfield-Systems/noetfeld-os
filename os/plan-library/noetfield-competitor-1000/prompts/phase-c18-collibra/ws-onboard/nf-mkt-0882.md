# nf-mkt-0882 — Collibra · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Collibra motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0882`
