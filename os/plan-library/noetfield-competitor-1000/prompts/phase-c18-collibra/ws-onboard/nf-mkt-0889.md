# nf-mkt-0889 — Collibra · Onboarding & PLG
...
Docs: onboarding section cites Collibra as market analog with https://www.collibra.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0889`
