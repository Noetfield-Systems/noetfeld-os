# nf-mkt-0860 — Collibra · Buyer-visible UX
...
Mark nf-mkt-0860 done in REGISTRY with evidence path + https://www.collibra.com after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0860`
