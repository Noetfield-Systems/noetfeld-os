# nf-mkt-0852 — Collibra · Buyer-visible UX
...
Write one-line UX spec: `Collibra Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Data lineage on AI outputs (pattern))
...
1. `status: done` in REGISTRY.json for `nf-mkt-0852`
