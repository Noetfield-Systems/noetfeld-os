# nf-mkt-0853 — Collibra · Buyer-visible UX
...
Add `Noetfield NW1 Copilot governance + board pack` UI field or copy block implementing smallest slice of `Data lineage on AI outputs (pattern)`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `nf-mkt-0853`
