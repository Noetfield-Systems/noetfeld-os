# nf-mkt-0859 — Collibra · Buyer-visible UX
...
Ship summary in PRIORITY: preserved · changed · achieved vs Collibra Buyer-visible UX
...
1. `status: done` in REGISTRY.json for `nf-mkt-0859`
