# nf-mkt-0855 — Collibra · Buyer-visible UX
...
Diff our public copy vs Collibra pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `nf-mkt-0855`
