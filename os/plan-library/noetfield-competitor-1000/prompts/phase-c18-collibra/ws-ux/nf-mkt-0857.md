# nf-mkt-0857 — Collibra · Buyer-visible UX
...
Document who buys (Data governance teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Collibra
...
1. `status: done` in REGISTRY.json for `nf-mkt-0857`
