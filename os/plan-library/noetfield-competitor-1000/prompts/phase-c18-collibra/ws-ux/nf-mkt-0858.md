# nf-mkt-0858 — Collibra · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Collibra (Data + AI governance)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0858`
