# nf-mkt-0851 — Collibra · Buyer-visible UX
...
Open https://www.collibra.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Collibra uses; paste into plan evidence (vendor says: Data governance extended to AI assets)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0851`
