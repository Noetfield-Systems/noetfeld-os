# nf-mkt-0875 — Collibra · Run history & proof
...
Add retention note: how long run history kept vs Collibra (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0875`
