# nf-mkt-0871 — Collibra · Run history & proof
...
From https://www.collibra.com document Collibra run/history UX: Catalog data and AI; lineage; policy — map to `TLE evaluate + drift export + copilot pilot e2e`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0871`
