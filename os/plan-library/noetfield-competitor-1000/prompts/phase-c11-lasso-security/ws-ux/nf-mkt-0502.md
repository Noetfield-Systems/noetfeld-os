# nf-mkt-0502 — Lasso Security · Buyer-visible UX
...
Write one-line UX spec: `Lasso Security Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Shadow Copilot discovery for NW1)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0502`
