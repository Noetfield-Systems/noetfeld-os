# nf-mkt-0507 — Lasso Security · Buyer-visible UX
...
Document who buys (CISO) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Lasso Security
...
1. `status: done` in REGISTRY.json for `nf-mkt-0507`
