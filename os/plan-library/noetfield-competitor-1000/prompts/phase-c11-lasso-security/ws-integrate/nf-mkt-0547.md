# nf-mkt-0547 — Lasso Security · Integrations & API
...
Rate-limit + retry policy copied from Lasso Security operating model (Scan enterprise; policy enforcement)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0547`
