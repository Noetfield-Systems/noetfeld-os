# nf-mkt-0549 — Lasso Security · Integrations & API
...
Update catalog/registry row for integration — Lasso Security row 51
...
1. `status: done` in REGISTRY.json for `nf-mkt-0549`
