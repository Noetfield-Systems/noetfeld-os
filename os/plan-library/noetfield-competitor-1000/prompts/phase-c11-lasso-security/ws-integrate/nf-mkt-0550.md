# nf-mkt-0550 — Lasso Security · Integrations & API
...
Close nf-mkt-0550: integration receipt + verify PASS + https://www.lasso.security
...
1. `status: done` in REGISTRY.json for `nf-mkt-0550`
