# nf-mkt-0530 — Lasso Security · Run history & proof
...
Mark nf-mkt-0530 done with run page screenshot or receipt path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0530`
