# nf-mkt-0525 — Lasso Security · Run history & proof
...
Add retention note: how long run history kept vs Lasso Security (Custom tiers tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0525`
