# nf-mkt-0522 — Lasso Security · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Shadow Copilot discovery for NW1)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0522`
