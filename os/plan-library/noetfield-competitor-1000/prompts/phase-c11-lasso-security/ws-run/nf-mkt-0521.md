# nf-mkt-0521 — Lasso Security · Run history & proof
...
From https://www.lasso.security document Lasso Security run/history UX: Scan enterprise; policy enforcement — map to `TLE evaluate + drift export + copilot pilot e2e`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0521`
