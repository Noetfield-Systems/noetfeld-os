# nf-mkt-0515 — Lasso Security · Pricing & packaging
...
Compare Lasso Security PLG motion (GenAI security startup) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0515`
