# nf-mkt-0511 — Lasso Security · Pricing & packaging
...
Capture Lasso Security public pricing evidence: Custom tiers — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0511`
