# nf-mkt-0516 — Lasso Security · Pricing & packaging
...
Document why buyers pay per Lasso Security: Shadow Copilot and ChatGPT use — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0516`
