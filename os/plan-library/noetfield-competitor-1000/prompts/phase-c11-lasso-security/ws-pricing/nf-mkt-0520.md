# nf-mkt-0520 — Lasso Security · Pricing & packaging
...
Close nf-mkt-0520: PRIORITY row + verify PASS + link https://www.lasso.security
...
1. `status: done` in REGISTRY.json for `nf-mkt-0520`
