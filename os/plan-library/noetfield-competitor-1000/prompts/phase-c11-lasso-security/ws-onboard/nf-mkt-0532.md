# nf-mkt-0532 — Lasso Security · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Lasso Security motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0532`
