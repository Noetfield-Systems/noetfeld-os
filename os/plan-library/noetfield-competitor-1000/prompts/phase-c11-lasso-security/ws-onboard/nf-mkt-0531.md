# nf-mkt-0531 — Lasso Security · Onboarding & PLG
...
Document Lasso Security onboarding path (GenAI security startup): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0531`
