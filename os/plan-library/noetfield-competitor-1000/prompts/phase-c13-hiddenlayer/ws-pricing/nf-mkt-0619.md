# nf-mkt-0619 — HiddenLayer · Pricing & packaging
...
Write competitor row evidence: HiddenLayer pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0619`
