# nf-mkt-0617 — HiddenLayer · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching HiddenLayer upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0617`
