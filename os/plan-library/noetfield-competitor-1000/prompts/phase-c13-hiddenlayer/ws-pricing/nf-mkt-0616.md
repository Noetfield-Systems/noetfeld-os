# nf-mkt-0616 — HiddenLayer · Pricing & packaging
...
Document why buyers pay per HiddenLayer: AI models are attack surface — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0616`
