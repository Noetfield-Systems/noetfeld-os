# nf-mkt-0620 — HiddenLayer · Pricing & packaging
...
Close nf-mkt-0620: PRIORITY row + verify PASS + link https://hiddenlayer.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0620`
