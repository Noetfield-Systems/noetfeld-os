# nf-mkt-0611 — HiddenLayer · Pricing & packaging
...
Capture HiddenLayer public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0611`
