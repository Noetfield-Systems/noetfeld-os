# nf-mkt-0632 — HiddenLayer · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from HiddenLayer motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0632`
