# nf-mkt-0631 — HiddenLayer · Onboarding & PLG
...
Document HiddenLayer onboarding path (ML security specialist): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0631`
