# nf-mkt-0639 — HiddenLayer · Onboarding & PLG
...
Docs: onboarding section cites HiddenLayer as market analog with https://hiddenlayer.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0639`
