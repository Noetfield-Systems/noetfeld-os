# nf-mkt-0636 — HiddenLayer · Onboarding & PLG
...
Write founder-facing SOW snippet if HiddenLayer uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0636`
