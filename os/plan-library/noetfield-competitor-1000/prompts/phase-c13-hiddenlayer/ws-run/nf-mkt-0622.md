# nf-mkt-0622 — HiddenLayer · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Threat detection on AI apps)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0622`
