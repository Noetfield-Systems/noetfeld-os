# nf-mkt-0625 — HiddenLayer · Run history & proof
...
Add retention note: how long run history kept vs HiddenLayer (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0625`
