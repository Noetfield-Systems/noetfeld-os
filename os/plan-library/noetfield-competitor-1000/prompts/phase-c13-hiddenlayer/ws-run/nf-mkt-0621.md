# nf-mkt-0621 — HiddenLayer · Run history & proof
...
From https://hiddenlayer.com document HiddenLayer run/history UX: Monitor models; detect adversarial attacks — map to `TLE evaluate + drift export + copilot pilot e2e`

## Implementation extraction

`HiddenLayer · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0621`
