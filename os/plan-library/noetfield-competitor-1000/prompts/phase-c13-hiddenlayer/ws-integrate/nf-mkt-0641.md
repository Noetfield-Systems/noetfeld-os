# nf-mkt-0641 — HiddenLayer · Integrations & API
...
List HiddenLayer integrations/APIs from https://hiddenlayer.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `nf-mkt-0641`
