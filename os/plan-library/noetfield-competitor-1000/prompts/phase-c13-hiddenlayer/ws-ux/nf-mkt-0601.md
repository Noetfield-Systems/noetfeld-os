# nf-mkt-0601 — HiddenLayer · Buyer-visible UX
...
Open https://hiddenlayer.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence HiddenLayer uses; paste into plan evidence (vendor says: Model security and threat detection for AI)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0601`
