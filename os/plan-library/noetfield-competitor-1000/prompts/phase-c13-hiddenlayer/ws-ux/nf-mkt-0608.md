# nf-mkt-0608 — HiddenLayer · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from HiddenLayer (ML security)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0608`
