# nf-mkt-0602 — HiddenLayer · Buyer-visible UX
...
Write one-line UX spec: `HiddenLayer Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Threat detection on AI apps)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0602`
