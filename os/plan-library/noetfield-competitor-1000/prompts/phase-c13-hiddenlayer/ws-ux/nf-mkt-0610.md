# nf-mkt-0610 — HiddenLayer · Buyer-visible UX
...
Mark nf-mkt-0610 done in REGISTRY with evidence path + https://hiddenlayer.com after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0610`
