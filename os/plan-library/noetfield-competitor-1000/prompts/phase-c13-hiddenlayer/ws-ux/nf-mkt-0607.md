# nf-mkt-0607 — HiddenLayer · Buyer-visible UX
...
Document who buys (Security operations) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for HiddenLayer
...
1. `status: done` in REGISTRY.json for `nf-mkt-0607`
