# nf-mkt-0603 — HiddenLayer · Buyer-visible UX
...
Add `Noetfield NW1 Copilot governance + board pack` UI field or copy block implementing smallest slice of `Threat detection on AI apps`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `nf-mkt-0603`
