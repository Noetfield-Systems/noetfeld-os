# nf-mkt-0381 — Arthur AI · Onboarding & PLG
...
Document Arthur AI onboarding path (ML monitoring brand): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0381`
