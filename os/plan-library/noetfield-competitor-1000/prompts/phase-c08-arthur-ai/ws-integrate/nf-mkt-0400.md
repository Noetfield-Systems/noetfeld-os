# nf-mkt-0400 — Arthur AI · Integrations & API
...
Close nf-mkt-0400: integration receipt + verify PASS + https://www.arthur.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0400`
