# nf-mkt-0397 — Arthur AI · Integrations & API
...
Rate-limit + retry policy copied from Arthur AI operating model (Ingest outputs; dashboards; alerts)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0397`
