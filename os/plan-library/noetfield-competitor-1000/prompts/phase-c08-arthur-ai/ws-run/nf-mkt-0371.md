# nf-mkt-0371 — Arthur AI · Run history & proof
...
From https://www.arthur.ai document Arthur AI run/history UX: Ingest outputs; dashboards; alerts — map to `TLE evaluate + drift export + copilot pilot e2e`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0371`
