# nf-mkt-0372 — Arthur AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Drift alerts on Copilot outputs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0372`
