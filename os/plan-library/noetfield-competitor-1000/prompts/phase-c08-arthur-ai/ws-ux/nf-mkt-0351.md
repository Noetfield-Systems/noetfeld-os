# nf-mkt-0351 — Arthur AI · Buyer-visible UX
...
Open https://www.arthur.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Arthur AI uses; paste into plan evidence (vendor says: Monitor model and LLM quality, bias, drift)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0351`
