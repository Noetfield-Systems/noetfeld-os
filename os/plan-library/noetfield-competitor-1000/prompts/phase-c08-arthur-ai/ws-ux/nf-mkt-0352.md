# nf-mkt-0352 — Arthur AI · Buyer-visible UX
...
Write one-line UX spec: `Arthur AI Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Drift alerts on Copilot outputs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0352`
