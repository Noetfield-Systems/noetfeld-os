# nf-mkt-0358 — Arthur AI · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Arthur AI (AI performance monitoring)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0358`
