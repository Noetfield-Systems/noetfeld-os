# nf-mkt-0357 — Arthur AI · Buyer-visible UX
...
Document who buys (Model owners) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Arthur AI
...
1. `status: done` in REGISTRY.json for `nf-mkt-0357`
