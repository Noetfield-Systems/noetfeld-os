# nf-mkt-0360 — Arthur AI · Buyer-visible UX
...
Mark nf-mkt-0360 done in REGISTRY with evidence path + https://www.arthur.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0360`
