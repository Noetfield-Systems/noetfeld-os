# nf-mkt-0366 — Arthur AI · Pricing & packaging
...
Document why buyers pay per Arthur AI: Copilot answers degrade over time unnoticed — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0366`
