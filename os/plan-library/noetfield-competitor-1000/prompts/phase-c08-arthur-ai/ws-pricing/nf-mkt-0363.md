# nf-mkt-0363 — Arthur AI · Pricing & packaging
...
Add or update one public price card on `Noetfield NW1 Copilot governance + board pack` inspired by Arthur AI packaging motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0363`
