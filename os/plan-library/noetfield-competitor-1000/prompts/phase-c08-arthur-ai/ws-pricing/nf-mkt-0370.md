# nf-mkt-0370 — Arthur AI · Pricing & packaging
...
Close nf-mkt-0370: PRIORITY row + verify PASS + link https://www.arthur.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0370`
