# nf-mkt-0036 — VerifyWise · Onboarding & PLG
...
Write founder-facing SOW snippet if VerifyWise uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0036`
