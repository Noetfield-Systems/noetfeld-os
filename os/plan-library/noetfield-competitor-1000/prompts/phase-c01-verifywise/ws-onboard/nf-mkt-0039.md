# nf-mkt-0039 — VerifyWise · Onboarding & PLG
...
Docs: onboarding section cites VerifyWise as market analog with https://verifywise.ai · https://verifywise.ai/pricing
...
1. `status: done` in REGISTRY.json for `nf-mkt-0039`
