# nf-mkt-0032 — VerifyWise · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from VerifyWise motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0032`
