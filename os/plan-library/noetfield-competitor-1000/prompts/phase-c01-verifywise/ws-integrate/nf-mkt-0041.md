# nf-mkt-0041 — VerifyWise · Integrations & API
...
List VerifyWise integrations/APIs from https://verifywise.ai · https://verifywise.ai/pricing or docs — pick one we can wire this quarter

## Implementation extraction

`VerifyWise · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0041`
