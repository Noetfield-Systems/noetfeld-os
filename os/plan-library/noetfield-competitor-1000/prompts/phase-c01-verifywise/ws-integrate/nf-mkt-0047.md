# nf-mkt-0047 — VerifyWise · Integrations & API
...
Rate-limit + retry policy copied from VerifyWise operating model (Registry → risk assessment → policy enforcement → audit export)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0047`
