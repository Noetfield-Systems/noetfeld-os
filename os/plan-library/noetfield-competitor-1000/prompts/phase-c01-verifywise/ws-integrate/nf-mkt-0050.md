# nf-mkt-0050 — VerifyWise · Integrations & API
...
Close nf-mkt-0050: integration receipt + verify PASS + https://verifywise.ai · https://verifywise.ai/pricing
...
1. `status: done` in REGISTRY.json for `nf-mkt-0050`
