# nf-mkt-0009 — VerifyWise · Buyer-visible UX
...
Ship summary in PRIORITY: preserved · changed · achieved vs VerifyWise Buyer-visible UX
...
1. `status: done` in REGISTRY.json for `nf-mkt-0009`
