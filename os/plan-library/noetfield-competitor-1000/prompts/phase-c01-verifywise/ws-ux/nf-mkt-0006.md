# nf-mkt-0006 — VerifyWise · Buyer-visible UX
...
Add `TLE evaluate + drift export + copilot pilot e2e` mock row labeled mock_only until live — match VerifyWise run/history metaphor not invented name
...
1. `status: done` in REGISTRY.json for `nf-mkt-0006`
