# nf-mkt-0001 — VerifyWise · Buyer-visible UX
...
Open https://verifywise.ai · https://verifywise.ai/pricing — screenshot or quote the exact buyer-facing Buyer-visible UX sentence VerifyWise uses; paste into plan evidence (vendor says: Register, assess, govern, and monitor AI systems — EU AI Act, ISO 42001, NIST)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0001`
