# nf-mkt-0002 — VerifyWise · Buyer-visible UX
...
Write one-line UX spec: `VerifyWise Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: AI system inventory + one-click board export for Copilot programs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0002`
