# nf-mkt-0003 — VerifyWise · Buyer-visible UX
...
Add `Noetfield NW1 Copilot governance + board pack` UI field or copy block implementing smallest slice of `AI system inventory + one-click board export for Copilot programs`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `nf-mkt-0003`
