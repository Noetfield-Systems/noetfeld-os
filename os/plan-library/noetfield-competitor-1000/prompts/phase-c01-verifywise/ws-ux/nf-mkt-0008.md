# nf-mkt-0008 — VerifyWise · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from VerifyWise (AI governance platform)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0008`
