# nf-mkt-0010 — VerifyWise · Buyer-visible UX
...
Mark nf-mkt-0010 done in REGISTRY with evidence path + https://verifywise.ai · https://verifywise.ai/pricing after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0010`
