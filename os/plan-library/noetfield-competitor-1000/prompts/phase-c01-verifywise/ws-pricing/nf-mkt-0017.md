# nf-mkt-0017 — VerifyWise · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching VerifyWise upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0017`
