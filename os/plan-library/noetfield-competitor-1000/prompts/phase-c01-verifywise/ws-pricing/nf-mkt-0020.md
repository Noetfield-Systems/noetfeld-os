# nf-mkt-0020 — VerifyWise · Pricing & packaging
...
Close nf-mkt-0020: PRIORITY row + verify PASS + link https://verifywise.ai · https://verifywise.ai/pricing
...
1. `status: done` in REGISTRY.json for `nf-mkt-0020`
