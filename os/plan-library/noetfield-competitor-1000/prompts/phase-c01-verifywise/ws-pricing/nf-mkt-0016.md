# nf-mkt-0016 — VerifyWise · Pricing & packaging
...
Document why buyers pay per VerifyWise: Six-figure Credo contracts exclude startups — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0016`
