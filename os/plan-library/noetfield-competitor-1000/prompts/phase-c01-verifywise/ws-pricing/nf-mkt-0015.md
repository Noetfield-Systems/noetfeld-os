# nf-mkt-0015 — VerifyWise · Pricing & packaging
...
Compare VerifyWise PLG motion (Open source → free tier → enterprise) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0015`
