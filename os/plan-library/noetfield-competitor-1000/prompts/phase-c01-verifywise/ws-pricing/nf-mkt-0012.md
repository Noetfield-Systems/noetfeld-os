# nf-mkt-0012 — VerifyWise · Pricing & packaging
...
Map VerifyWise revenue model (No per-seat; enterprise deployment) to our `CAD $2K shadow pilot → annual design partner` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `nf-mkt-0012`
