# nf-mkt-0011 — VerifyWise · Pricing & packaging
...
Capture VerifyWise public pricing evidence: Free start; Enterprise Plus custom — https://verifywise.ai/pricing — save link or quoted range in plan receipt

## Implementation extraction

`VerifyWise · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0011`
