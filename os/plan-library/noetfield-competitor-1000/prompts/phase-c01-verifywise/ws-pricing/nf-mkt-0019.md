# nf-mkt-0019 — VerifyWise · Pricing & packaging
...
Write competitor row evidence: VerifyWise pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0019`
