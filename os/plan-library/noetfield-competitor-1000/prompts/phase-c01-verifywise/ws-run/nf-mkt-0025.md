# nf-mkt-0025 — VerifyWise · Run history & proof
...
Add retention note: how long run history kept vs VerifyWise (Free start; Enterprise Plus custom — https://verifywise.ai/pricing tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0025`
