# nf-mkt-0022 — VerifyWise · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: AI system inventory + one-click board export for Copilot programs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0022`
