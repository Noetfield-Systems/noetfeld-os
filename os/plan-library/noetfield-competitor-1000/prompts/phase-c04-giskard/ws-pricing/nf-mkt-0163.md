# nf-mkt-0163 — Giskard · Pricing & packaging
...
Add or update one public price card on `Noetfield NW1 Copilot governance + board pack` inspired by Giskard packaging motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0163`
