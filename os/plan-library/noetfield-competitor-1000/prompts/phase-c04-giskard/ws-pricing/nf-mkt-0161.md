# nf-mkt-0161 — Giskard · Pricing & packaging
...
Capture Giskard public pricing evidence: OSS free; Hub contact sales — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0161`
