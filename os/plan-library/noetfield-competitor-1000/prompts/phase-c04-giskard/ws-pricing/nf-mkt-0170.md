# nf-mkt-0170 — Giskard · Pricing & packaging
...
Close nf-mkt-0170: PRIORITY row + verify PASS + link https://www.giskard.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0170`
