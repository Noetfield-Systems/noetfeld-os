# nf-mkt-0172 — Giskard · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Pre-prod Copilot/agent regression tests)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0172`
