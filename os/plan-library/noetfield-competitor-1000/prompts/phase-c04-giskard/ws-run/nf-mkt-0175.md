# nf-mkt-0175 — Giskard · Run history & proof
...
Add retention note: how long run history kept vs Giskard (OSS free; Hub contact sales tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0175`
