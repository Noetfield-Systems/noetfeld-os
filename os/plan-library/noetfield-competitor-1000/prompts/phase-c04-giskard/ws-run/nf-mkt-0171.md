# nf-mkt-0171 — Giskard · Run history & proof
...
From https://www.giskard.ai document Giskard run/history UX: Test library in CI; Hub for continuous red-team — map to `TLE evaluate + drift export + copilot pilot e2e`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0171`
