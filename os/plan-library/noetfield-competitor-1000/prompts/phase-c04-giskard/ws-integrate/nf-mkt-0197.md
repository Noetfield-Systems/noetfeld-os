# nf-mkt-0197 — Giskard · Integrations & API
...
Rate-limit + retry policy copied from Giskard operating model (Test library in CI; Hub for continuous red-team)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0197`
