# nf-mkt-0200 — Giskard · Integrations & API
...
Close nf-mkt-0200: integration receipt + verify PASS + https://www.giskard.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0200`
