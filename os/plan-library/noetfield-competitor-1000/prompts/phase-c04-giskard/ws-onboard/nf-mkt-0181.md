# nf-mkt-0181 — Giskard · Onboarding & PLG
...
Document Giskard onboarding path (OSS Paris 2021): who runs (OSS + Hub enterprise) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0181`
