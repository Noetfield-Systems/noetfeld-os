# nf-mkt-0151 — Giskard · Buyer-visible UX
...
Open https://www.giskard.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Giskard uses; paste into plan evidence (vendor says: Test AI agents to catch issues before production)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0151`
