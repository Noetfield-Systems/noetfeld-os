# nf-mkt-0158 — Giskard · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Giskard (LLM agent testing)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0158`
