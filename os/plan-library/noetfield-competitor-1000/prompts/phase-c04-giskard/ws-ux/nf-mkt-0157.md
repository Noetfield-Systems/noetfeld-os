# nf-mkt-0157 — Giskard · Buyer-visible UX
...
Document who buys (ML and AI QA engineers) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Giskard
...
1. `status: done` in REGISTRY.json for `nf-mkt-0157`
