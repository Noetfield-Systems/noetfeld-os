# nf-mkt-0152 — Giskard · Buyer-visible UX
...
Write one-line UX spec: `Giskard Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Pre-prod Copilot/agent regression tests)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0152`
