# nf-mkt-0160 — Giskard · Buyer-visible UX
...
Mark nf-mkt-0160 done in REGISTRY with evidence path + https://www.giskard.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0160`
