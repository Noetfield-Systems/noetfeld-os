# nf-mkt-0802 — Braintrust · Buyer-visible UX
...
Write one-line UX spec: `Braintrust Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Board metric: pass rate trend over time)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0802`
