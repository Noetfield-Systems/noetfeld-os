# nf-mkt-0801 — Braintrust · Buyer-visible UX
...
Open https://www.braintrust.dev — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Braintrust uses; paste into plan evidence (vendor says: Evals and logging for AI products in production)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0801`
