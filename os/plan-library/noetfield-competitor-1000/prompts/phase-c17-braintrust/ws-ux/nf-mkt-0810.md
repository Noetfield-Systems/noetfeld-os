# nf-mkt-0810 — Braintrust · Buyer-visible UX
...
Mark nf-mkt-0810 done in REGISTRY with evidence path + https://www.braintrust.dev after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0810`
