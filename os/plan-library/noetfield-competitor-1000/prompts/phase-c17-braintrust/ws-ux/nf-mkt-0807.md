# nf-mkt-0807 — Braintrust · Buyer-visible UX
...
Document who buys (AI product teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Braintrust
...
1. `status: done` in REGISTRY.json for `nf-mkt-0807`
