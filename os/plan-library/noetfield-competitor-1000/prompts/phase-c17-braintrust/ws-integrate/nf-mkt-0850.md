# nf-mkt-0850 — Braintrust · Integrations & API
...
Close nf-mkt-0850: integration receipt + verify PASS + https://www.braintrust.dev
...
1. `status: done` in REGISTRY.json for `nf-mkt-0850`
