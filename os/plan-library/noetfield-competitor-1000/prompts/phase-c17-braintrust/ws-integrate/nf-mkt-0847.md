# nf-mkt-0847 — Braintrust · Integrations & API
...
Rate-limit + retry policy copied from Braintrust operating model (Log production; run eval suites; compare versions)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0847`
