# nf-mkt-0820 — Braintrust · Pricing & packaging
...
Close nf-mkt-0820: PRIORITY row + verify PASS + link https://www.braintrust.dev
...
1. `status: done` in REGISTRY.json for `nf-mkt-0820`
