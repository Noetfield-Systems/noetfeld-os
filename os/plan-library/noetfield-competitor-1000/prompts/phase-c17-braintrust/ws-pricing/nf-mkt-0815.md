# nf-mkt-0815 — Braintrust · Pricing & packaging
...
Compare Braintrust PLG motion (Eval-first for AI products) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0815`
