# nf-mkt-0831 — Braintrust · Onboarding & PLG
...
Document Braintrust onboarding path (Eval-first for AI products): who runs (Managed cloud) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0831`
