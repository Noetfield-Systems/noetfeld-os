# nf-mkt-0822 — Braintrust · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Board metric: pass rate trend over time)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0822`
