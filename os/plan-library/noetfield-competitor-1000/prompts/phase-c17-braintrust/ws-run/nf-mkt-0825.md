# nf-mkt-0825 — Braintrust · Run history & proof
...
Add retention note: how long run history kept vs Braintrust (From ~$249/mo tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0825`
