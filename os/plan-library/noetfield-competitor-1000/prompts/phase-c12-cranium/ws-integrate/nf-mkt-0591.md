# nf-mkt-0591 — Cranium · Integrations & API
...
List Cranium integrations/APIs from https://cranium.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `nf-mkt-0591`
