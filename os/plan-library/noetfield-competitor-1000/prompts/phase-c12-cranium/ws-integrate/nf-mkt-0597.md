# nf-mkt-0597 — Cranium · Integrations & API
...
Rate-limit + retry policy copied from Cranium operating model (Discover AI assets; assess vendor AI risk)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0597`
