# nf-mkt-0572 — Cranium · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Third-party AI inventory)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0572`
