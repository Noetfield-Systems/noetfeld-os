# nf-mkt-0571 — Cranium · Run history & proof
...
From https://cranium.ai document Cranium run/history UX: Discover AI assets; assess vendor AI risk — map to `TLE evaluate + drift export + copilot pilot e2e`

## Implementation extraction

`Cranium · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0571`
