# nf-mkt-0575 — Cranium · Run history & proof
...
Add retention note: how long run history kept vs Cranium (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0575`
