# nf-mkt-0581 — Cranium · Onboarding & PLG
...
Document Cranium onboarding path (AI security startup): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0581`
