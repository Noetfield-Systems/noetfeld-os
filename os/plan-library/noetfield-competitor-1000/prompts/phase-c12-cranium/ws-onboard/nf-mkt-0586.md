# nf-mkt-0586 — Cranium · Onboarding & PLG
...
Write founder-facing SOW snippet if Cranium uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0586`
