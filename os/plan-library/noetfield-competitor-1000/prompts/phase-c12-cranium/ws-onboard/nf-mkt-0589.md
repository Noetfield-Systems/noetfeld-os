# nf-mkt-0589 — Cranium · Onboarding & PLG
...
Docs: onboarding section cites Cranium as market analog with https://cranium.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0589`
