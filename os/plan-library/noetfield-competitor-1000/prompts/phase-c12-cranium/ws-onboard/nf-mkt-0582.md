# nf-mkt-0582 — Cranium · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Cranium motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0582`
