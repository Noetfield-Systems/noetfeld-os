# nf-mkt-0552 — Cranium · Buyer-visible UX
...
Write one-line UX spec: `Cranium Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Third-party AI inventory)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0552`
