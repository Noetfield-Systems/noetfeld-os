# nf-mkt-0560 — Cranium · Buyer-visible UX
...
Mark nf-mkt-0560 done in REGISTRY with evidence path + https://cranium.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0560`
