# nf-mkt-0555 — Cranium · Buyer-visible UX
...
Diff our public copy vs Cranium pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `nf-mkt-0555`
