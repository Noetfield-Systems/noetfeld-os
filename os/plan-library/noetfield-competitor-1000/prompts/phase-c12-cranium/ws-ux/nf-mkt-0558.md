# nf-mkt-0558 — Cranium · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Cranium (AI security platform)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0558`
