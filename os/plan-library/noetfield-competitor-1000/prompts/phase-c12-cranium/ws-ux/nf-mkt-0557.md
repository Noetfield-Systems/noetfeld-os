# nf-mkt-0557 — Cranium · Buyer-visible UX
...
Document who buys (Security teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Cranium
...
1. `status: done` in REGISTRY.json for `nf-mkt-0557`
