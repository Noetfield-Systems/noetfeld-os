# nf-mkt-0563 — Cranium · Pricing & packaging
...
Add or update one public price card on `Noetfield NW1 Copilot governance + board pack` inspired by Cranium packaging motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0563`
