# nf-mkt-0566 — Cranium · Pricing & packaging
...
Document why buyers pay per Cranium: Third-party AI in supply chain is invisible — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0566`
