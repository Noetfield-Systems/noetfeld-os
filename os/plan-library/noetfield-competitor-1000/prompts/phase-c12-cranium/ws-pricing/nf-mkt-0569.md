# nf-mkt-0569 — Cranium · Pricing & packaging
...
Write competitor row evidence: Cranium pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0569`
