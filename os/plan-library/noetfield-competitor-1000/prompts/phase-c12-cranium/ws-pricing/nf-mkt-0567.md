# nf-mkt-0567 — Cranium · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Cranium upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0567`
