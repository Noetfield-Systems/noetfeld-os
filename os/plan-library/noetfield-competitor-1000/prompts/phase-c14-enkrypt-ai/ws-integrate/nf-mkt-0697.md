# nf-mkt-0697 — Enkrypt AI · Integrations & API
...
Rate-limit + retry policy copied from Enkrypt AI operating model (Proxy LLM calls; policy enforcement log)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0697`
