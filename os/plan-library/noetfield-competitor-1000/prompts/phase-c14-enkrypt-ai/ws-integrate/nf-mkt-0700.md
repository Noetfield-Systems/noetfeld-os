# nf-mkt-0700 — Enkrypt AI · Integrations & API
...
Close nf-mkt-0700: integration receipt + verify PASS + https://www.enkryptai.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0700`
