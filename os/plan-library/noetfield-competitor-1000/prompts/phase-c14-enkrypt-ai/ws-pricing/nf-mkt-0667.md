# nf-mkt-0667 — Enkrypt AI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Enkrypt AI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0667`
