# nf-mkt-0665 — Enkrypt AI · Pricing & packaging
...
Compare Enkrypt AI PLG motion (LLM firewall startup) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0665`
