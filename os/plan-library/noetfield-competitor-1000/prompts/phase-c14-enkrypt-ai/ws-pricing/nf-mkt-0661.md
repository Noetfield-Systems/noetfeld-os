# nf-mkt-0661 — Enkrypt AI · Pricing & packaging
...
Capture Enkrypt AI public pricing evidence: Startup tiers — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0661`
