# nf-mkt-0670 — Enkrypt AI · Pricing & packaging
...
Close nf-mkt-0670: PRIORITY row + verify PASS + link https://www.enkryptai.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0670`
