# nf-mkt-0666 — Enkrypt AI · Pricing & packaging
...
Document why buyers pay per Enkrypt AI: Data leakage via LLM prompts — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0666`
