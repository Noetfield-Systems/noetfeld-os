# nf-mkt-0672 — Enkrypt AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Policy enforcement log per call)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0672`
