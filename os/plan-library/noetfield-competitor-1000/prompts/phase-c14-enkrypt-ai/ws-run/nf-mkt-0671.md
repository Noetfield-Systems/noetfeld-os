# nf-mkt-0671 — Enkrypt AI · Run history & proof
...
From https://www.enkryptai.com document Enkrypt AI run/history UX: Proxy LLM calls; policy enforcement log — map to `TLE evaluate + drift export + copilot pilot e2e`

## Implementation extraction

`Enkrypt AI · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0671`
