# nf-mkt-0675 — Enkrypt AI · Run history & proof
...
Add retention note: how long run history kept vs Enkrypt AI (Startup tiers tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0675`
