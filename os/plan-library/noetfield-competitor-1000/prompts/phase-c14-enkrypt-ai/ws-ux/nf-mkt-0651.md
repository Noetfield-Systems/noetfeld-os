# nf-mkt-0651 — Enkrypt AI · Buyer-visible UX
...
Open https://www.enkryptai.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Enkrypt AI uses; paste into plan evidence (vendor says: Secure gateway for LLM applications)

## Implementation extraction

`Enkrypt AI · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0651`
