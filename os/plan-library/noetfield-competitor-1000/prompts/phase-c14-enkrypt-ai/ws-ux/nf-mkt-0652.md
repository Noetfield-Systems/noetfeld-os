# nf-mkt-0652 — Enkrypt AI · Buyer-visible UX
...
Write one-line UX spec: `Enkrypt AI Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Policy enforcement log per call)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0652`
