# nf-mkt-0657 — Enkrypt AI · Buyer-visible UX
...
Document who buys (Security teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Enkrypt AI
...
1. `status: done` in REGISTRY.json for `nf-mkt-0657`
