# nf-mkt-0681 — Enkrypt AI · Onboarding & PLG
...
Document Enkrypt AI onboarding path (LLM firewall startup): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0681`
