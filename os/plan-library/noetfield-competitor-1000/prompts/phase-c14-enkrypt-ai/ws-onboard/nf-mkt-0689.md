# nf-mkt-0689 — Enkrypt AI · Onboarding & PLG
...
Docs: onboarding section cites Enkrypt AI as market analog with https://www.enkryptai.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0689`
