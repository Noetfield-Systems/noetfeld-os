# nf-mkt-0682 — Enkrypt AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Enkrypt AI motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0682`
