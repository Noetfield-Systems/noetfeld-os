# nf-mkt-0750 — ModelOp · Integrations & API
...
Close nf-mkt-0750: integration receipt + verify PASS + https://www.modelop.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0750`
