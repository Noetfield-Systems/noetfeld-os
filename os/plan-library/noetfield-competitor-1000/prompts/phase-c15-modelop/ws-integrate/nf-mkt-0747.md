# nf-mkt-0747 — ModelOp · Integrations & API
...
Rate-limit + retry policy copied from ModelOp operating model (Model inventory; governance workflows; reporting)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0747`
