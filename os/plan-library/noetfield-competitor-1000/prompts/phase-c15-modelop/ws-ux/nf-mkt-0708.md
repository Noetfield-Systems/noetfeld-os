# nf-mkt-0708 — ModelOp · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from ModelOp (Model governance)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0708`
