# nf-mkt-0702 — ModelOp · Buyer-visible UX
...
Write one-line UX spec: `ModelOp Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Enterprise AI registry pattern)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0702`
