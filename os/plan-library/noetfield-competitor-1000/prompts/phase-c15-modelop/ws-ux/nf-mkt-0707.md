# nf-mkt-0707 — ModelOp · Buyer-visible UX
...
Document who buys (Bank/insurance compliance) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for ModelOp
...
1. `status: done` in REGISTRY.json for `nf-mkt-0707`
