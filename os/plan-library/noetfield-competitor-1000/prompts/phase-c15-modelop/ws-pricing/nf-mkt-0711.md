# nf-mkt-0711 — ModelOp · Pricing & packaging
...
Capture ModelOp public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0711`
