# nf-mkt-0719 — ModelOp · Pricing & packaging
...
Write competitor row evidence: ModelOp pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0719`
