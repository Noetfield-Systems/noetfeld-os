# nf-mkt-0717 — ModelOp · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching ModelOp upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0717`
