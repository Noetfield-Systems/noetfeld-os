# nf-mkt-0720 — ModelOp · Pricing & packaging
...
Close nf-mkt-0720: PRIORITY row + verify PASS + link https://www.modelop.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0720`
