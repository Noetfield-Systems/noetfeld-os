# nf-mkt-0716 — ModelOp · Pricing & packaging
...
Document why buyers pay per ModelOp: Regulators require model inventory — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0716`
