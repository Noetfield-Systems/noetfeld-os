# nf-mkt-0739 — ModelOp · Onboarding & PLG
...
Docs: onboarding section cites ModelOp as market analog with https://www.modelop.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0739`
