# nf-mkt-0731 — ModelOp · Onboarding & PLG
...
Document ModelOp onboarding path (Financial services ML governance): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0731`
