# nf-mkt-0732 — ModelOp · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from ModelOp motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0732`
