# nf-mkt-0736 — ModelOp · Onboarding & PLG
...
Write founder-facing SOW snippet if ModelOp uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0736`
