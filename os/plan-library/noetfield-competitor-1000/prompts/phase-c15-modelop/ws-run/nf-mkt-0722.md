# nf-mkt-0722 — ModelOp · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Enterprise AI registry pattern)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0722`
