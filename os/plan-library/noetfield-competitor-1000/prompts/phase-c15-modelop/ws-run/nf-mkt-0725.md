# nf-mkt-0725 — ModelOp · Run history & proof
...
Add retention note: how long run history kept vs ModelOp (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0725`
