# nf-mkt-0447 — Fiddler AI · Integrations & API
...
Rate-limit + retry policy copied from Fiddler AI operating model (Explain predictions; monitor drift; report)

## Implementation extraction

`Fiddler AI · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0447`
