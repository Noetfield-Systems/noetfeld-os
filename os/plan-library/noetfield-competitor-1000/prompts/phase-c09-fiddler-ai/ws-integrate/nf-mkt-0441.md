# nf-mkt-0441 — Fiddler AI · Integrations & API
...
List Fiddler AI integrations/APIs from https://www.fiddler.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `nf-mkt-0441`
