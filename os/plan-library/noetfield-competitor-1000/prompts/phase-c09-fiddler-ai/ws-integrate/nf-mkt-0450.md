# nf-mkt-0450 — Fiddler AI · Integrations & API
...
Close nf-mkt-0450: integration receipt + verify PASS + https://www.fiddler.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0450`
