# nf-mkt-0413 — Fiddler AI · Pricing & packaging
...
Add or update one public price card on `Noetfield NW1 Copilot governance + board pack` inspired by Fiddler AI packaging motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0413`
