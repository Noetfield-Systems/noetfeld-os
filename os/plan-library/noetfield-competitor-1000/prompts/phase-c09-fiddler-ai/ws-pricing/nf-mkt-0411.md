# nf-mkt-0411 — Fiddler AI · Pricing & packaging
...
Capture Fiddler AI public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0411`
