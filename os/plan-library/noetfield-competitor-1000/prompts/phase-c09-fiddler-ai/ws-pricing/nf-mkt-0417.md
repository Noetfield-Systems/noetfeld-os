# nf-mkt-0417 — Fiddler AI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Fiddler AI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0417`
