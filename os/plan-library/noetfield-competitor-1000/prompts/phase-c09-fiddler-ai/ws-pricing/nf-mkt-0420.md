# nf-mkt-0420 — Fiddler AI · Pricing & packaging
...
Close nf-mkt-0420: PRIORITY row + verify PASS + link https://www.fiddler.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0420`
