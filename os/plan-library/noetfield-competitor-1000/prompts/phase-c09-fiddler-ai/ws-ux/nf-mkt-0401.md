# nf-mkt-0401 — Fiddler AI · Buyer-visible UX
...
Open https://www.fiddler.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Fiddler AI uses; paste into plan evidence (vendor says: Explainability and monitoring for ML models)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0401`
