# nf-mkt-0408 — Fiddler AI · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Fiddler AI (Model performance management)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0408`
