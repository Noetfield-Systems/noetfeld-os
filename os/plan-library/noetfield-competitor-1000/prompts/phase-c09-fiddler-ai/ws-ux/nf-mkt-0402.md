# nf-mkt-0402 — Fiddler AI · Buyer-visible UX
...
Write one-line UX spec: `Fiddler AI Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Explainability on high-risk Copilot answers)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0402`
