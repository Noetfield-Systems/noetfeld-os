# nf-mkt-0407 — Fiddler AI · Buyer-visible UX
...
Document who buys (ML platform teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Fiddler AI
...
1. `status: done` in REGISTRY.json for `nf-mkt-0407`
