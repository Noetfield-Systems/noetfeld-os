# nf-mkt-0431 — Fiddler AI · Onboarding & PLG
...
Document Fiddler AI onboarding path (Explainability wedge): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0431`
