# nf-mkt-0432 — Fiddler AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Fiddler AI motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0432`
