# nf-mkt-0425 — Fiddler AI · Run history & proof
...
Add retention note: how long run history kept vs Fiddler AI (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0425`
