# nf-mkt-0422 — Fiddler AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Explainability on high-risk Copilot answers)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0422`
