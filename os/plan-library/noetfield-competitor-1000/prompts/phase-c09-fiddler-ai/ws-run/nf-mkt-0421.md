# nf-mkt-0421 — Fiddler AI · Run history & proof
...
From https://www.fiddler.ai document Fiddler AI run/history UX: Explain predictions; monitor drift; report — map to `TLE evaluate + drift export + copilot pilot e2e`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0421`
