# nf-mkt-0925 — OneTrust · Run history & proof
...
Add retention note: how long run history kept vs OneTrust (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0925`
