# nf-mkt-0922 — OneTrust · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: DPIA + AI use register (pattern))
...
1. `status: done` in REGISTRY.json for `nf-mkt-0922`
