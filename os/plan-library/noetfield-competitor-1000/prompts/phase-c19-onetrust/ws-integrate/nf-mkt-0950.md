# nf-mkt-0950 — OneTrust · Integrations & API
...
Close nf-mkt-0950: integration receipt + verify PASS + https://www.onetrust.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0950`
