# nf-mkt-0932 — OneTrust · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from OneTrust motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0932`
