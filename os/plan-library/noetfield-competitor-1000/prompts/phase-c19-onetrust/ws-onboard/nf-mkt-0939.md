# nf-mkt-0939 — OneTrust · Onboarding & PLG
...
Docs: onboarding section cites OneTrust as market analog with https://www.onetrust.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0939`
