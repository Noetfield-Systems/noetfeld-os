# nf-mkt-0936 — OneTrust · Onboarding & PLG
...
Write founder-facing SOW snippet if OneTrust uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0936`
