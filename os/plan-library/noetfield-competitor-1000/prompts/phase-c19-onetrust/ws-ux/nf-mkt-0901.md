# nf-mkt-0901 — OneTrust · Buyer-visible UX
...
Open https://www.onetrust.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence OneTrust uses; paste into plan evidence (vendor says: Privacy, GRC, and AI governance modules)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0901`
