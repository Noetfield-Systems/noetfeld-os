# nf-mkt-0910 — OneTrust · Buyer-visible UX
...
Mark nf-mkt-0910 done in REGISTRY with evidence path + https://www.onetrust.com after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0910`
