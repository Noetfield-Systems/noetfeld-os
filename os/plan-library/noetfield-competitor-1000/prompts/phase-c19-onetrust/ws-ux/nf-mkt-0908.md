# nf-mkt-0908 — OneTrust · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from OneTrust (Privacy + AI governance)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0908`
