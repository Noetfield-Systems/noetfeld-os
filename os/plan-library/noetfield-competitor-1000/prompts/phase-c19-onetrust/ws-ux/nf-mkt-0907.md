# nf-mkt-0907 — OneTrust · Buyer-visible UX
...
Document who buys (Privacy and GRC leaders) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for OneTrust
...
1. `status: done` in REGISTRY.json for `nf-mkt-0907`
