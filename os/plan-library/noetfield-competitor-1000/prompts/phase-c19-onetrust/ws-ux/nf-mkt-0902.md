# nf-mkt-0902 — OneTrust · Buyer-visible UX
...
Write one-line UX spec: `OneTrust Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: DPIA + AI use register (pattern))
...
1. `status: done` in REGISTRY.json for `nf-mkt-0902`
