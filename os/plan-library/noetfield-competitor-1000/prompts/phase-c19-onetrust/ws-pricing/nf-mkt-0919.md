# nf-mkt-0919 — OneTrust · Pricing & packaging
...
Write competitor row evidence: OneTrust pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0919`
