# nf-mkt-0917 — OneTrust · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching OneTrust upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0917`
