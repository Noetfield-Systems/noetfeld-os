# nf-mkt-0920 — OneTrust · Pricing & packaging
...
Close nf-mkt-0920: PRIORITY row + verify PASS + link https://www.onetrust.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0920`
