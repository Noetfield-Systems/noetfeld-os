# nf-mkt-0915 — OneTrust · Pricing & packaging
...
Compare OneTrust PLG motion (Privacy platform adds AI module) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`

## Implementation extraction

`OneTrust · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0915`
