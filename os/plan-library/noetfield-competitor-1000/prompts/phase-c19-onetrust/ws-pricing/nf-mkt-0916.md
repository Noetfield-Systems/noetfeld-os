# nf-mkt-0916 — OneTrust · Pricing & packaging
...
Document why buyers pay per OneTrust: Privacy and AI regulations overlap — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0916`
