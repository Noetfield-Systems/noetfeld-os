# nf-mkt-0911 — OneTrust · Pricing & packaging
...
Capture OneTrust public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0911`
