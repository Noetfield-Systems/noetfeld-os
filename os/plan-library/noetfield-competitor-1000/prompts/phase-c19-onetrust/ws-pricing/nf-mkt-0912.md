# nf-mkt-0912 — OneTrust · Pricing & packaging
...
Map OneTrust revenue model (Annual enterprise) to our `CAD $2K shadow pilot → annual design partner` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `nf-mkt-0912`
