# nf-mkt-0765 — Langfuse · Pricing & packaging
...
Compare Langfuse PLG motion (OSS → cloud) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0765`
