# nf-mkt-0762 — Langfuse · Pricing & packaging
...
Map Langfuse revenue model (Usage SaaS + OSS) to our `CAD $2K shadow pilot → annual design partner` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `nf-mkt-0762`
