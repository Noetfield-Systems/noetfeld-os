# nf-mkt-0770 — Langfuse · Pricing & packaging
...
Close nf-mkt-0770: PRIORITY row + verify PASS + link https://langfuse.com/pricing
...
1. `status: done` in REGISTRY.json for `nf-mkt-0770`
