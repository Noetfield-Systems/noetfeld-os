# nf-mkt-0797 — Langfuse · Integrations & API
...
Rate-limit + retry policy copied from Langfuse operating model (OpenTelemetry traces; session tracking; cost dashboard)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0797`
