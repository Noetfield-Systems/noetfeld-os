# nf-mkt-0791 — Langfuse · Integrations & API
...
List Langfuse integrations/APIs from https://langfuse.com/pricing or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `nf-mkt-0791`
