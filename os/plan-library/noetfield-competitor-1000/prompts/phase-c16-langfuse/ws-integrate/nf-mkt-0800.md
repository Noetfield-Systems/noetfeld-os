# nf-mkt-0800 — Langfuse · Integrations & API
...
Close nf-mkt-0800: integration receipt + verify PASS + https://langfuse.com/pricing
...
1. `status: done` in REGISTRY.json for `nf-mkt-0800`
