# nf-mkt-0782 — Langfuse · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Langfuse motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0782`
