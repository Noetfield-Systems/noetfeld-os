# nf-mkt-0789 — Langfuse · Onboarding & PLG
...
Docs: onboarding section cites Langfuse as market analog with https://langfuse.com/pricing
...
1. `status: done` in REGISTRY.json for `nf-mkt-0789`
