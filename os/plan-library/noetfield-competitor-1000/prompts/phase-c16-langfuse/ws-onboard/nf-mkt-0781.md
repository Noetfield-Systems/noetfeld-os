# nf-mkt-0781 — Langfuse · Onboarding & PLG
...
Document Langfuse onboarding path (OSS → cloud): who runs (Cloud or self-host MIT) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0781`
