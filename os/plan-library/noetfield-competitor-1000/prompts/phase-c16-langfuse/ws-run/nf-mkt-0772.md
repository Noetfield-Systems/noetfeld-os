# nf-mkt-0772 — Langfuse · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Per-action audit trail for Copilot runs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0772`
