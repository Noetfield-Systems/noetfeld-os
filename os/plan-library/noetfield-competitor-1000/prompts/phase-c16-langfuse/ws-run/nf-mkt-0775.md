# nf-mkt-0775 — Langfuse · Run history & proof
...
Add retention note: how long run history kept vs Langfuse (Free 50k obs; Core $29/mo — https://langfuse.com/pricing tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0775`
