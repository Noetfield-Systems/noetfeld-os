# nf-mkt-0752 — Langfuse · Buyer-visible UX
...
Write one-line UX spec: `Langfuse Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Per-action audit trail for Copilot runs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0752`
