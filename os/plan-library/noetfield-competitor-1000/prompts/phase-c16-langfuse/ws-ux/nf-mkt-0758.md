# nf-mkt-0758 — Langfuse · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Langfuse (LLM observability)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0758`
