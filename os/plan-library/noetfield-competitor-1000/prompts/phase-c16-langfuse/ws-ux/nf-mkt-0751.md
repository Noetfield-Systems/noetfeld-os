# nf-mkt-0751 — Langfuse · Buyer-visible UX
...
Open https://langfuse.com/pricing — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Langfuse uses; paste into plan evidence (vendor says: Traces, evals, prompts for LLM applications)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0751`
