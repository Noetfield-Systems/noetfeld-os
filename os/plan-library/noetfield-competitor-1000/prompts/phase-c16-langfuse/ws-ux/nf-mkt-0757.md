# nf-mkt-0757 — Langfuse · Buyer-visible UX
...
Document who buys (AI engineering) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Langfuse
...
1. `status: done` in REGISTRY.json for `nf-mkt-0757`
