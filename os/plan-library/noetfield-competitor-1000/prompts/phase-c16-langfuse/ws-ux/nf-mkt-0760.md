# nf-mkt-0760 — Langfuse · Buyer-visible UX
...
Mark nf-mkt-0760 done in REGISTRY with evidence path + https://langfuse.com/pricing after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0760`
