# nf-mkt-0062 — FairNow · Pricing & packaging
...
Map FairNow revenue model (Enterprise annual SaaS) to our `CAD $2K shadow pilot → annual design partner` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `nf-mkt-0062`
