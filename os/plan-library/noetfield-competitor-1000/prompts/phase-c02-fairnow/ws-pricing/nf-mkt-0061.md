# nf-mkt-0061 — FairNow · Pricing & packaging
...
Capture FairNow public pricing evidence: Contact sales; no public pricing — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0061`
