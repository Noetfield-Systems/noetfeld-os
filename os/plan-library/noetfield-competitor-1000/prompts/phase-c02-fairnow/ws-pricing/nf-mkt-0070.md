# nf-mkt-0070 — FairNow · Pricing & packaging
...
Close nf-mkt-0070: PRIORITY row + verify PASS + link https://www.fairnow.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0070`
