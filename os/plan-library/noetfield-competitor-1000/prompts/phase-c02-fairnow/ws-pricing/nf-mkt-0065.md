# nf-mkt-0065 — FairNow · Pricing & packaging
...
Compare FairNow PLG motion (Seed 2023 → AuditBoard acquisition) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0065`
