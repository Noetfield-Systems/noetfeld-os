# nf-mkt-0067 — FairNow · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching FairNow upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0067`
