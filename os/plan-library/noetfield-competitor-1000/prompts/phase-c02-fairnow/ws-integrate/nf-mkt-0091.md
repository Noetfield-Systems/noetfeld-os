# nf-mkt-0091 — FairNow · Integrations & API
...
List FairNow integrations/APIs from https://www.fairnow.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `nf-mkt-0091`
