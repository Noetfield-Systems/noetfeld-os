# nf-mkt-0097 — FairNow · Integrations & API
...
Rate-limit + retry policy copied from FairNow operating model (AI registry; automated bias tests; evidence collection)

## Implementation extraction

`FairNow · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0097`
