# nf-mkt-0100 — FairNow · Integrations & API
...
Close nf-mkt-0100: integration receipt + verify PASS + https://www.fairnow.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0100`
