# nf-mkt-0072 — FairNow · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Automated evidence collection for board packs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0072`
