# nf-mkt-0075 — FairNow · Run history & proof
...
Add retention note: how long run history kept vs FairNow (Contact sales; no public pricing tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0075`
