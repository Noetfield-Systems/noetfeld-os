# nf-mkt-0052 — FairNow · Buyer-visible UX
...
Write one-line UX spec: `FairNow Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Automated evidence collection for board packs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0052`
