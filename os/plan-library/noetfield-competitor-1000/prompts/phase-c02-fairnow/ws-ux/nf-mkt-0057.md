# nf-mkt-0057 — FairNow · Buyer-visible UX
...
Document who buys (Enterprise compliance in financial services and HR) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for FairNow
...
1. `status: done` in REGISTRY.json for `nf-mkt-0057`
