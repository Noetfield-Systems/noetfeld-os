# nf-mkt-0082 — FairNow · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from FairNow motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0082`
