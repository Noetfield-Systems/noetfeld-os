# nf-mkt-0089 — FairNow · Onboarding & PLG
...
Docs: onboarding section cites FairNow as market analog with https://www.fairnow.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0089`
