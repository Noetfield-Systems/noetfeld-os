# nf-mkt-0081 — FairNow · Onboarding & PLG
...
Document FairNow onboarding path (Seed 2023 → AuditBoard acquisition): who runs (Vendor SaaS (acquired AuditBoard 2025)) → first value moment

## Implementation extraction

`FairNow · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0081`
