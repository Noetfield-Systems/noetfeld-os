# nf-mkt-0331 — Monitaur · Onboarding & PLG
...
Document Monitaur onboarding path (Regulated ML focus): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0331`
