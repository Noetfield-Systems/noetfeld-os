# nf-mkt-0322 — Monitaur · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Approval workflow per AI system)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0322`
