# nf-mkt-0315 — Monitaur · Pricing & packaging
...
Compare Monitaur PLG motion (Regulated ML focus) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0315`
