# nf-mkt-0320 — Monitaur · Pricing & packaging
...
Close nf-mkt-0320: PRIORITY row + verify PASS + link https://www.monitaur.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0320`
