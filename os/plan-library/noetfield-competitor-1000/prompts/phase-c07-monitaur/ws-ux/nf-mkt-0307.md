# nf-mkt-0307 — Monitaur · Buyer-visible UX
...
Document who buys (Regulated industries) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Monitaur
...
1. `status: done` in REGISTRY.json for `nf-mkt-0307`
