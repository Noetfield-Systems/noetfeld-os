# nf-mkt-0308 — Monitaur · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Monitaur (ML governance)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0308`
