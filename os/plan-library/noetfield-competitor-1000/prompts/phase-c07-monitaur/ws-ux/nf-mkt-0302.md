# nf-mkt-0302 — Monitaur · Buyer-visible UX
...
Write one-line UX spec: `Monitaur Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Approval workflow per AI system)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0302`
