# nf-mkt-0301 — Monitaur · Buyer-visible UX
...
Open https://www.monitaur.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Monitaur uses; paste into plan evidence (vendor says: End-to-end ML governance lifecycle)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0301`
