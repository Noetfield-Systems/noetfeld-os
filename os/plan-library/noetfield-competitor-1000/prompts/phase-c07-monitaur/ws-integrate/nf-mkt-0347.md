# nf-mkt-0347 — Monitaur · Integrations & API
...
Rate-limit + retry policy copied from Monitaur operating model (Document models; approval workflows; audit logs)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0347`
