# nf-mkt-0350 — Monitaur · Integrations & API
...
Close nf-mkt-0350: integration receipt + verify PASS + https://www.monitaur.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0350`
