# nf-mkt-0231 — Promptfoo · Onboarding & PLG
...
Document Promptfoo onboarding path (OSS → OpenAI acquisition 2026): who runs (OSS + enterprise) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0231`
