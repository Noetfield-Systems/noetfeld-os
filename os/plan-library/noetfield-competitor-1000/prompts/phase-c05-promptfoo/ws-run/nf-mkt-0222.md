# nf-mkt-0222 — Promptfoo · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Microsoft Copilot plugin eval gate in CI)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0222`
