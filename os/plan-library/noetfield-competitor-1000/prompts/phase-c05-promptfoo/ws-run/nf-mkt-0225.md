# nf-mkt-0225 — Promptfoo · Run history & proof
...
Add retention note: how long run history kept vs Promptfoo (Community free; enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0225`
