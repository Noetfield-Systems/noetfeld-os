# nf-mkt-0221 — Promptfoo · Run history & proof
...
From https://www.promptfoo.dev document Promptfoo run/history UX: CLI matrix evals; 50+ attack plugins — map to `TLE evaluate + drift export + copilot pilot e2e`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0221`
