# nf-mkt-0216 — Promptfoo · Pricing & packaging
...
Document why buyers pay per Promptfoo: AI security vulnerabilities before production — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0216`
