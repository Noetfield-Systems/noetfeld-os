# nf-mkt-0220 — Promptfoo · Pricing & packaging
...
Close nf-mkt-0220: PRIORITY row + verify PASS + link https://www.promptfoo.dev
...
1. `status: done` in REGISTRY.json for `nf-mkt-0220`
