# nf-mkt-0215 — Promptfoo · Pricing & packaging
...
Compare Promptfoo PLG motion (OSS → OpenAI acquisition 2026) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0215`
