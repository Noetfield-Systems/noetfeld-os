# nf-mkt-0212 — Promptfoo · Pricing & packaging
...
Map Promptfoo revenue model (OSS + enterprise) to our `CAD $2K shadow pilot → annual design partner` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `nf-mkt-0212`
