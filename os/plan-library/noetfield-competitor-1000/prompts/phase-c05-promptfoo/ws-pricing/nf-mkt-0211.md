# nf-mkt-0211 — Promptfoo · Pricing & packaging
...
Capture Promptfoo public pricing evidence: Community free; enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0211`
