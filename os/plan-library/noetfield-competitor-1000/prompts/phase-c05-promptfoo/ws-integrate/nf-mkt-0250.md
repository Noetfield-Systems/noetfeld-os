# nf-mkt-0250 — Promptfoo · Integrations & API
...
Close nf-mkt-0250: integration receipt + verify PASS + https://www.promptfoo.dev
...
1. `status: done` in REGISTRY.json for `nf-mkt-0250`
