# nf-mkt-0247 — Promptfoo · Integrations & API
...
Rate-limit + retry policy copied from Promptfoo operating model (CLI matrix evals; 50+ attack plugins)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0247`
