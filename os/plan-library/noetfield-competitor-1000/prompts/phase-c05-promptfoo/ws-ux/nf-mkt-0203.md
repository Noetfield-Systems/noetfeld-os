# nf-mkt-0203 — Promptfoo · Buyer-visible UX
...
Add `Noetfield NW1 Copilot governance + board pack` UI field or copy block implementing smallest slice of `Microsoft Copilot plugin eval gate in CI`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `nf-mkt-0203`
