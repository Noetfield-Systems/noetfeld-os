# nf-mkt-0208 — Promptfoo · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Promptfoo (LLM security eval)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0208`
