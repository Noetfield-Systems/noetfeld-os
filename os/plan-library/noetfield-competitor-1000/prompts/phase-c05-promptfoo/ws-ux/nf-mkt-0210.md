# nf-mkt-0210 — Promptfoo · Buyer-visible UX
...
Mark nf-mkt-0210 done in REGISTRY with evidence path + https://www.promptfoo.dev after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0210`
