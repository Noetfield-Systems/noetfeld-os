# nf-mkt-0202 — Promptfoo · Buyer-visible UX
...
Write one-line UX spec: `Promptfoo Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Microsoft Copilot plugin eval gate in CI)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0202`
