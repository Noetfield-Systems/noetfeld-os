# nf-mkt-0207 — Promptfoo · Buyer-visible UX
...
Document who buys (DevSec and platform teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Promptfoo
...
1. `status: done` in REGISTRY.json for `nf-mkt-0207`
