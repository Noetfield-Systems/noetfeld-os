# nf-mkt-0201 — Promptfoo · Buyer-visible UX
...
Open https://www.promptfoo.dev — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Promptfoo uses; paste into plan evidence (vendor says: Red-team and eval prompts, agents, RAG in CI)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0201`
