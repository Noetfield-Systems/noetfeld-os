# nf-mkt-0101 — Credo AI · Buyer-visible UX
...
Open https://www.credo.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Credo AI uses; paste into plan evidence (vendor says: Discover, assess, and govern every AI agent, model, and application continuously)

## Implementation extraction

`Credo AI · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0101`
