# nf-mkt-0110 — Credo AI · Buyer-visible UX
...
Mark nf-mkt-0110 done in REGISTRY with evidence path + https://www.credo.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0110`
