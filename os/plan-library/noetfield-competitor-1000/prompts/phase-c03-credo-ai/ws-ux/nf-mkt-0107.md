# nf-mkt-0107 — Credo AI · Buyer-visible UX
...
Document who buys (Fortune 500 and regulated enterprises) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Credo AI
...
1. `status: done` in REGISTRY.json for `nf-mkt-0107`
