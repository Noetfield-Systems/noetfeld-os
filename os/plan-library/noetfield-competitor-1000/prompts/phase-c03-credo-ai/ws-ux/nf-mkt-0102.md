# nf-mkt-0102 — Credo AI · Buyer-visible UX
...
Write one-line UX spec: `Credo AI Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Board-ready audit pack pattern for NW1 Copilot wedge)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0102`
