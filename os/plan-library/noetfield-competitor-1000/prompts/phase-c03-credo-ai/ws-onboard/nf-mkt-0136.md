# nf-mkt-0136 — Credo AI · Onboarding & PLG
...
Write founder-facing SOW snippet if Credo AI uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0136`
