# nf-mkt-0131 — Credo AI · Onboarding & PLG
...
Document Credo AI onboarding path (Forrester Wave Leader; policy pack co-authoring): who runs (Enterprise SaaS) → first value moment

## Implementation extraction

`Credo AI · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0131`
