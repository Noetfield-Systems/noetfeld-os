# nf-mkt-0121 — Credo AI · Run history & proof
...
From https://www.credo.ai document Credo AI run/history UX: AI Registry + Policy Engine + Risk Intelligence — map to `TLE evaluate + drift export + copilot pilot e2e`

## Implementation extraction

`Credo AI · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0121`
