# nf-mkt-0125 — Credo AI · Run history & proof
...
Add retention note: how long run history kept vs Credo AI (Contact sales; six-figure contracts typical (market) tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0125`
