# nf-mkt-0116 — Credo AI · Pricing & packaging
...
Document why buyers pay per Credo AI: Regulators demand continuous AI governance not quarterly audits — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0116`
