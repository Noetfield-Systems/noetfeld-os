# nf-mkt-0119 — Credo AI · Pricing & packaging
...
Write competitor row evidence: Credo AI pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0119`
