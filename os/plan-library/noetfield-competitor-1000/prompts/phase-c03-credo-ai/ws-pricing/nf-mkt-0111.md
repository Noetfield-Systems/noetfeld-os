# nf-mkt-0111 — Credo AI · Pricing & packaging
...
Capture Credo AI public pricing evidence: Contact sales; six-figure contracts typical (market) — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `nf-mkt-0111`
