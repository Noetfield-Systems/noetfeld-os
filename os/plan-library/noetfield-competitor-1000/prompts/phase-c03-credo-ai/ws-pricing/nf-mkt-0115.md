# nf-mkt-0115 — Credo AI · Pricing & packaging
...
Compare Credo AI PLG motion (Forrester Wave Leader; policy pack co-authoring) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`

## Implementation extraction

`Credo AI · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0115`
