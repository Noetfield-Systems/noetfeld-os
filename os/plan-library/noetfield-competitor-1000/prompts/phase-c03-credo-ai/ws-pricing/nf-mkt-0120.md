# nf-mkt-0120 — Credo AI · Pricing & packaging
...
Close nf-mkt-0120: PRIORITY row + verify PASS + link https://www.credo.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0120`
