# nf-mkt-0141 — Credo AI · Integrations & API
...
List Credo AI integrations/APIs from https://www.credo.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `nf-mkt-0141`
