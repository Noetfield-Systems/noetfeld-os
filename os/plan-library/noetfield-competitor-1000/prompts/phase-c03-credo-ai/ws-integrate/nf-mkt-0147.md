# nf-mkt-0147 — Credo AI · Integrations & API
...
Rate-limit + retry policy copied from Credo AI operating model (AI Registry + Policy Engine + Risk Intelligence)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0147`
