# nf-mkt-0150 — Credo AI · Integrations & API
...
Close nf-mkt-0150: integration receipt + verify PASS + https://www.credo.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0150`
