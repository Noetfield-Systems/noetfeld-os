# nf-mkt-0251 — Holistic AI · Buyer-visible UX
...
Open https://www.holisticai.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Holistic AI uses; paste into plan evidence (vendor says: Enterprise AI risk scoring and governance dashboard)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0251`
