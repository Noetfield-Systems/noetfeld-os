# nf-mkt-0257 — Holistic AI · Buyer-visible UX
...
Document who buys (Chief Risk Officers) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Holistic AI
...
1. `status: done` in REGISTRY.json for `nf-mkt-0257`
