# nf-mkt-0260 — Holistic AI · Buyer-visible UX
...
Mark nf-mkt-0260 done in REGISTRY with evidence path + https://www.holisticai.com after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0260`
