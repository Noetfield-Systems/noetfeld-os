# nf-mkt-0252 — Holistic AI · Buyer-visible UX
...
Write one-line UX spec: `Holistic AI Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Copilot use-case risk register)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0252`
