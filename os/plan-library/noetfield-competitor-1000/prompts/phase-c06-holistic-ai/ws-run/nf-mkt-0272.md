# nf-mkt-0272 — Holistic AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Copilot use-case risk register)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0272`
