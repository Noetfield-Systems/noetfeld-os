# nf-mkt-0265 — Holistic AI · Pricing & packaging
...
Compare Holistic AI PLG motion (Enterprise sales) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0265`
