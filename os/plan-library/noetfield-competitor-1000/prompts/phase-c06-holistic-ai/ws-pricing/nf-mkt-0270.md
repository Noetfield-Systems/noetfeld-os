# nf-mkt-0270 — Holistic AI · Pricing & packaging
...
Close nf-mkt-0270: PRIORITY row + verify PASS + link https://www.holisticai.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0270`
