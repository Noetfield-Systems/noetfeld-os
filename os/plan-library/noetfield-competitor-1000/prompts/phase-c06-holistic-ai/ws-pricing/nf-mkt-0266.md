# nf-mkt-0266 — Holistic AI · Pricing & packaging
...
Document why buyers pay per Holistic AI: EU AI Act and board scrutiny on AI — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0266`
