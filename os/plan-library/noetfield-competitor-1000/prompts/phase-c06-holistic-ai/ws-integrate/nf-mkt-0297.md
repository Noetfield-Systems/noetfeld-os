# nf-mkt-0297 — Holistic AI · Integrations & API
...
Rate-limit + retry policy copied from Holistic AI operating model (Inventory; risk score; monitor drift)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0297`
