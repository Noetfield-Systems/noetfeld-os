# nf-mkt-0300 — Holistic AI · Integrations & API
...
Close nf-mkt-0300: integration receipt + verify PASS + https://www.holisticai.com
...
1. `status: done` in REGISTRY.json for `nf-mkt-0300`
