# nf-mkt-0281 — Holistic AI · Onboarding & PLG
...
Document Holistic AI onboarding path (Enterprise sales): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `nf-mkt-0281`
