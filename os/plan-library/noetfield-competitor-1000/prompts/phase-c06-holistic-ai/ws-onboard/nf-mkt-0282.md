# nf-mkt-0282 — Holistic AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Procurement pack + demo-to-SOW path` copied from Holistic AI motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0282`
