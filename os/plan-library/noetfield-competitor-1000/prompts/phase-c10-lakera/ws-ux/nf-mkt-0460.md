# nf-mkt-0460 — Lakera · Buyer-visible UX
...
Mark nf-mkt-0460 done in REGISTRY with evidence path + https://www.lakera.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `nf-mkt-0460`
