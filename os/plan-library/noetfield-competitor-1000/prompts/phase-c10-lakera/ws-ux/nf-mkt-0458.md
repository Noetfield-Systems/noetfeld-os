# nf-mkt-0458 — Lakera · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Lakera (LLM firewall)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0458`
