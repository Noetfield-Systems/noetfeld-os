# nf-mkt-0457 — Lakera · Buyer-visible UX
...
Document who buys (AppSec teams) vs our ICP one sentence on `os/plan-library/NOETFIELD-PRIORITY.md` row for Lakera
...
1. `status: done` in REGISTRY.json for `nf-mkt-0457`
