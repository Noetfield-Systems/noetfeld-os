# nf-mkt-0451 — Lakera · Buyer-visible UX
...
Open https://www.lakera.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Lakera uses; paste into plan evidence (vendor says: Runtime security for GenAI applications)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0451`
