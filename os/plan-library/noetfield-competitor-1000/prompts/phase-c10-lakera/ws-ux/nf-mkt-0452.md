# nf-mkt-0452 — Lakera · Buyer-visible UX
...
Write one-line UX spec: `Lakera Buyer-visible UX` → buyer sees X → we show on `Noetfield NW1 Copilot governance + board pack` (lesson: Block/allow log per prompt at dispatch)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0452`
