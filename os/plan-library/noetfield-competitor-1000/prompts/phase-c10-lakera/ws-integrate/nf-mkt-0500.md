# nf-mkt-0500 — Lakera · Integrations & API
...
Close nf-mkt-0500: integration receipt + verify PASS + https://www.lakera.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0500`
