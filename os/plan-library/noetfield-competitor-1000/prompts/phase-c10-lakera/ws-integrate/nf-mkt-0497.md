# nf-mkt-0497 — Lakera · Integrations & API
...
Rate-limit + retry policy copied from Lakera operating model (API guard scans prompts; block/allow log)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0497`
