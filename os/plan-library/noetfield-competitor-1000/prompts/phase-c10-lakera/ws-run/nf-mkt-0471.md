# nf-mkt-0471 — Lakera · Run history & proof
...
From https://www.lakera.ai document Lakera run/history UX: API guard scans prompts; block/allow log — map to `TLE evaluate + drift export + copilot pilot e2e`

## Implementation extraction

`Lakera · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `nf-mkt-0471`
