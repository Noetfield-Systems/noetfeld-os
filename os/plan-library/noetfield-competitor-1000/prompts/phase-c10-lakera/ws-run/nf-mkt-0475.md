# nf-mkt-0475 — Lakera · Run history & proof
...
Add retention note: how long run history kept vs Lakera (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0475`
