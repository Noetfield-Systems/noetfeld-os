# nf-mkt-0472 — Lakera · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Block/allow log per prompt at dispatch)
...
1. `status: done` in REGISTRY.json for `nf-mkt-0472`
