# nf-mkt-0489 — Lakera · Onboarding & PLG
...
Docs: onboarding section cites Lakera as market analog with https://www.lakera.ai
...
1. `status: done` in REGISTRY.json for `nf-mkt-0489`
