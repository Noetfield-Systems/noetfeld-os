# nf-mkt-0486 — Lakera · Onboarding & PLG
...
Write founder-facing SOW snippet if Lakera uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `nf-mkt-0486`
