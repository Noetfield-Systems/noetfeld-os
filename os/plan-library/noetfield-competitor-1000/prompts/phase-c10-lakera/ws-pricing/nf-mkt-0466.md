# nf-mkt-0466 — Lakera · Pricing & packaging
...
Document why buyers pay per Lakera: Prompt injection on enterprise Copilot — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `nf-mkt-0466`
