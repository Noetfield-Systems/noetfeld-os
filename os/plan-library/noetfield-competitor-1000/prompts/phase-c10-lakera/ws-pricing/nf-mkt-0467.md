# nf-mkt-0467 — Lakera · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Lakera upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `nf-mkt-0467`
