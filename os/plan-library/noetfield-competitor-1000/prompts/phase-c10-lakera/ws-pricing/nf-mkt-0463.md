# nf-mkt-0463 — Lakera · Pricing & packaging
...
Add or update one public price card on `Noetfield NW1 Copilot governance + board pack` inspired by Lakera packaging motion
...
1. `status: done` in REGISTRY.json for `nf-mkt-0463`
