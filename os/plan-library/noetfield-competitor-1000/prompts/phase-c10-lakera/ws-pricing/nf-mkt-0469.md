# nf-mkt-0469 — Lakera · Pricing & packaging
...
Write competitor row evidence: Lakera pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `nf-mkt-0469`
