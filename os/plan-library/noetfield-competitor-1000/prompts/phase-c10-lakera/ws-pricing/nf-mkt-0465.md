# nf-mkt-0465 — Lakera · Pricing & packaging
...
Compare Lakera PLG motion (GenAI security) vs our onboarding — one adoption fix on `Procurement pack + demo-to-SOW path`
...
1. `status: done` in REGISTRY.json for `nf-mkt-0465`
