...
- **Chatbot knowledge Phase A** ✅ in Noetfield repo — deploy platform to go live · `Noetfield/docs/ops/CHATBOT_KNOWLEDGE_UPGRADE_LOCKED_v1.md`
- **Still open:** PyPI publish live · npm `@noetfield/gate` · chatbot Phases 3–10
