...
### GTM_NEXT (top picks — iter 15)

1. **ship-trust-brief-parity-audit-045** · Verify trust-brief CTAs on hub, pilot, demo, procurement
1. **ship-merged-pr-open-prs-gate-046** · OPEN_PRS recently merged includes #41–#43
1. **ship-demo-rehearsal-demo-047** · Demo rehearsal link in demo script steps ol
