...
python3 scripts/nf_mono_nerve_v1.py --json >/dev/null 2>&1 || true
python3 scripts/nf_founder_input_sync_v1.py --json >/dev/null 2>&1 || true
...
python3 scripts/nf_live_surfaces_v1.py --json >/dev/null 2>&1 || true
python3 scripts/nf_orient_read_chain_v1.py --json >/dev/null 2>&1 || true
bash scripts/nf_routing_card.sh --json >/dev/null 2>&1 || true
python3 scripts/nf_anti_staleness_max_v1.py --json >/dev/null 2>&1 || true
