...
VAULT="/Users/sinakazemnezhad/Projects/noetfeld-os/docs/_NOOS_AGENT"
ROOT="/Users/sinakazemnezhad/Projects/noetfeld-os"
...
path = Path("/Users/sinakazemnezhad/Projects/noetfeld-os/docs/_NOOS_AGENT/NOETFIELD_UNIFIED_MASTER_v1_LOCKED.md")
...
cp ~/Desktop/SourceA/NOETFIELD_UNIFIED_MASTER_v1_LOCKED.md \\
   ~/Projects/noetfeld-os/docs/_NOOS_AGENT/NOETFIELD_UNIFIED_MASTER_v1_LOCKED.md

cp ~/Desktop/SourceA/NOETFIELD_OS_SSOT_v1_LOCKED.md \\
   ~/Projects/noetfeld-os/docs/_NOOS_AGENT/NOETFIELD_OS_SSOT_v1_LOCKED.md
```"""
